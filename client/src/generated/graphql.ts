...
export type GetCurrentUserQuery = { __typename?: 'Query', getCurrentUser: { __typename?: 'User', id: number, username: string, bio?: string | null, profilePicture?: string | null, uuid: string, createdAt: any, followersCount: number, followingCount: number, postsCount: number, posts?: Array<{ __typename?: 'Post', title: string, content: string }> | null } };
